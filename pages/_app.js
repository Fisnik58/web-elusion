    ...
    <div className="cookies-banner">
      <div className="cookies-content">
        ...
        <div className="buttons-container">
          <button onClick={onAcceptCookies} className="cookies-button-1">
            Accept Cookies
          </button>
          <button onClick={onRejectCookies} className="cookies-button-2">
            Reject Cookies
          </button>
        </div>
      </div>
          ...
          <div className="everything">
            {
              ...
              >
                  ...
                  <div className="row row-of-elusion">
                    <div className="col-md-12 col-lg-12 col-xl-6">
                      ...
                      <h4 className="Elusion-Text text-center fade-in">
                        Unleashing the Power of AI: Envisioning a New Era with
                        Elusion Where Artificial Intelligence Meets Crypto
                        Brilliance!
                      </h4>
                    </div>
                ...
                <div id="elusionop">
                  ...
                  <br />
                  <div
                    className="container container-of-ElusionOp fade-in"
                    style={{ backgroundColor: "purple" }}
                  >
                    <div style={{ paddingLeft: "3%" }}>
                      <div className="row">
                        <div
                          className="col-3 col-lg-3 col-md-3 text-center col-sm-3"
                    ...
                    <div
                      className="container container-of-play-to-earn"
                      style={{ backgroundColor: "#cb20ff" }}
                    >
                      <div className="row" style={{ paddingTop: "1%" }}>
                        <div className="col-xl-4 col-lg-12 mx-auto">
                          {" "}
                          {/* Add mx-auto class here */}
                          <h2
                            className="text-center  header-of-earn-1"
                            style={{ color: "purple" }}
                          >
                            Play to earn
                          </h2>
                          <h5
                            className="text-center text-of-earn-1"
                            style={{ color: "white" }}
                          >
                            Embark on an exhilarating journey with "Elusion,"
                            the ultimate play-to-earn game that combines
                            thrills, challenges, and rewards like never before.
                            In the fantastical realm of Elusion, you'll discover
                            a world filled with untold riches and opportunities
                            and opportunities
                          </h5>
                        </div>
                        <div className="col-xl-4 col-lg-12 mx-auto">
                          ...
                          <h5
                            style={{ color: "white" }}
                            className="text-center text-of-earn-m text-of-earn-2"
                          >
                            In "Elusion," a multitude of captivating characters
                            awaits your discovery within the mystical realm.
                            From seasoned warriors to enigmatic sorcerers, each
                            character possesses unique abilities and backgrounds
                            that add depth to the immersive gaming experience.
                          </h5>
                        </div>
                        <div className="col-xl-4 col-lg-12 mx-auto">
                          {" "}
                          ...
                          <h5
                            style={{ color: "white" }}
                            className="text-center text-of-earn-3"
                          >
                            Discover hidden caches of digital assets that hold
                            immense value within the blockchain-based economy of
                            Elusion. As you conquer formidable quests and rise
                            through the ranks, you'll earn tokens that grant you
                            access to exclusive features, rare cosmetic items,
                            and coveted in-game.
                          </h5>
                        </div>
                      </div>
...
<div className="col-xl-4" style={{backgroundColor:"#cb20ff",borderTopRightRadius:"15px",borderBottomRightRadius:"15px"}}>
  ...
  <h2 className="text-center" style={{color:"white"}}>Beast</h2>
                ...
                <div className="container container-of-tokenomics">
                  ...
                  <div className="row d-flex mx-auto" style={{ height: "30%" }}>
                    <div className="col-lg-3 about-tokenomic about-tokenomic-1 mx-auto fade-in">
                      <h4 className="text-center" style={{ color: "yellow" }}>
                        Public Sale
                      </h4>
                      <p className="text-center ">
                        The allocation of 50% of tokens for a public sale
                        implies that half of the total token supply is reserved
                        for public investors.{" "}
                      </p>
                    </div>
                    <div className="col-lg-3 about-tokenomic mx-auto fade-in">
                      <h4 className="text-center" style={{ color: "#ED5174" }}>
                        Cex listings
                      </h4>
                      <p className="text-center">
                        The allocation of 50% of tokens for a public sale
                    ...
                    <div className="col-lg-3 about-tokenomic mx-auto fade-in">
                      <h4 className="text-center" style={{ color: "#FD8963" }}>
                        Burned
                      </h4>
                      <p className="text-center">
                        The allocation of 50% of tokens for a public sale
                    ...
                    <div className="col-lg-3 about-tokenomic about-tokenomic-4 mx-auto fade-in">
                      <h4 className="text-center" style={{ color: "#FA26CA" }}>
                        Marketing
                      </h4>
                      <p className="text-center">
                        The allocation of 50% of tokens for a public sale
                      ...
                      <div style={{ height: "25%" }}>
                        <ul className="d-flex justify-content-between ul-1 ul-2 fade-in">
                          <li className="">
                            <h4>
                              50%
                              <sub style={{ color: "yellow" }}>Public Sale</sub>
                            </h4>
                            <p></p>
                          </li>
                        ...
                        >
                          <li>
                            <h4>
                              5%
                              <sub style={{ color: "#FA26CA" }}>Marketing</sub>
                            </h4>
                            <p></p>
                          </li>
                          <li>
                ...
                <div
                  className="container-fluid fluid-of-community fade-in"
                  style={{ backgroundColor: "purple" }}
                >
                    ...
                    <div className="row row-of-community">
                      <div className="col-lg-6 col-xl-5 row-community-1 fade-in">
                        ...
                        <p className="fade-in">
                          ...
                          innovators connected all over the world, building new
                          era of the internet.
                        </p>
                      </div>
                      <div className="col-lg-4 offset-lg-2 col-xl-4 offset-xl-3  offset-lg-2">
                        <div>
                          ...
                          <div>
                            <p className="p-of-community fade-in">
                        ...
                        <div className="fade-in">
                          ...
                          <div>
                            <p className="fade-in">
                              Follow{" "}
                              <span style={{ color: "#cb20ff" }}>
                                @pulseaiapp
                              </span>{" "}
                              to get the last news and updates from across the
                              ecosystem.
                            </p>
                          </div>
                        </div>
                ...
                <div className="container2 ">
                  <div className="container contr" id="aboutus">
                    ...
                    <div className="row rowwww" style={{ paddingTop: "5%" }}>
                      <div className="col-sm-6 col-xl-3 col-lg-6  col-md-6 rowww1 fade-in">
                        <div
                  ...
                  <div className="container container-of-footer">
                    <div className="row">
                      <div className="col-md-12">
                        <h1
                          style={{ color: "white" }}
                          className="header-of-footer fade-in"
                        >
                          Let's make it happen.
                        </h1>
                        <h6 style={{ color: "white " }} className="fade-in">
                          Ready to try elusion!
                        </h6>
                      </div>
                    </div>
                    <div className="row">
